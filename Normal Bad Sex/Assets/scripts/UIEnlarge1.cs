...
public class UIEnlarge1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (col!=null)
        {
            ...
            {
                scaled = true;
                Vector3 newScale = new Vector3(uiIransform.localScale.x + 0.05f, uiIransform.localScale.y + 0.05f, uiIransform.localScale.z);
